...
func main() {
	...
	// Perhaps the most basic file reading task is slurping a
	// file’s entire contents into memory.
	...
	// for its efficiency with many small reads and because of
